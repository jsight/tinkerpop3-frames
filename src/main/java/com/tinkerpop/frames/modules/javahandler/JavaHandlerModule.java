...
/**
 * <p>
 * Adds support for calling Java methods to handle a frames call. A call to a frames method annotated with {@link JavaHandler} will cause the supplied
 * factory to instantiate an instance of the handler class and call the appropriate method on it.
 * </p>
 * <p>
                ...
                throws ClassNotFoundException
    {
        ...
        if (frameClass.getClassLoader() == null)
        {
            throw new ClassNotFoundException(
                        "FrameClass: " + frameClass.getCanonicalName() + " getClassLoader() returned null... no $Impl can be found in this case!");
        }
