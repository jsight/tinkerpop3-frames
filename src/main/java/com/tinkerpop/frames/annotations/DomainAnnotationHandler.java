...
public class DomainAnnotationHandler implements AnnotationHandler<Domain>
{
    ...
    @Override
    public Object processElement(final Domain annotation, final Method method, final Object[] arguments, final FramedGraph framedGraph,
    ...
    {
        return framedGraph.frame(edge.vertices(direction).next(), method.getReturnType());
    }
