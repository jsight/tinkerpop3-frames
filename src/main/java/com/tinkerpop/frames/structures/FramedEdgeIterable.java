...
public class FramedEdgeIterable<T> implements Iterable<T>
{
    ...
    /**
     * @deprecated Use {@link #FramedEdgeIterable(FramedGraph, Iterable, Class)}, in combination with {@link InVertex}.
     */
    public FramedEdgeIterable(final FramedGraph<? extends Graph> framedGraph, final Iterable<Edge> iterable, final Direction direction,
                final Class<T> kind)
    {
